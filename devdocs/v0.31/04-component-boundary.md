...
> **编号映射**：本册使用 v3 编号（0.31.27–35）。roadmap.toml（v5）实际编号为 0.31.30–38。
> 对照：本册 27=roadmap 30, 28=31, 29=32, 30=33, 31=34, 32=35, 33=36, 34=37, 35=38。
> 此后重编号只改 roadmap.toml，本册头部映射同步更新。
