...
- **0.31.17**：Resolved IR -> trusted subset -> Verification IR -> CFG/SSA。
- **0.31.18**：checked i32/i64、definedness obligation、VC 与 counterexample。
- **0.31.19**：八结果代数、proof artifact、solver/infrastructure fail-closed。
- **0.31.20**：止血/攻击审查 II，0 新 proof feature。
