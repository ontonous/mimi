...
impl MirFfiScalarKind {
    ...
    pub(crate) fn abi_class(self) -> MirAbiClass {
        match self {
            ...
            Self::F32 => MirAbiClass::Float { bits: 32 },
...
impl MirAbiClass {
    ...
    pub(crate) fn canonical_ffi_scalar_kind(self) -> Option<MirFfiScalarKind> {
        match self {
            ...
            Self::Float { bits: 32 } => Some(MirFfiScalarKind::F32),
    ...
    pub fn for_kind(kind: MirBuiltinKind) -> Self {
        match kind {
            ...
            MirBuiltinKind::PrintlnString => Self {
                ...
                name: "println",
                arity: 1,
                input_abi: MirAbiClass::StringHandle,
                preserves_type: false,
                requires_copy: false,
                requires_same_input_type: false,
                overflow_trap: None,
...
impl MirTypeCatalog {
    ...
    /// projection shapes currently admitted: a one-, two-, three-, four-, five-, six-, or seven-field `Record<T>`
