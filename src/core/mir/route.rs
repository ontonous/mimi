...
use super::{
    ...
    classify_generic_option_projection_admission, classify_generic_variant_predicate_admission,
    ...
    contains_generic_option_projection_candidate, contains_generic_variant_predicate_candidate,
