...
/// one-, two-, three-, four-, five-, or six-field Copy contract, the two/three-field homogeneous owned
...
/// The generic record island admits one, two, three, four, five, or six fields. At least one field must
...
/// two-, three-, four-, five-, and six-field forms are intentionally bounded heterogeneous
...
fn is_scalar_generic_record_definition(
    ...
    if definition.kind != crate::core::ResolvedTypeKind::Record
        ...
        || !matches!(definition.fields.len(), 1 | 2 | 3 | 4 | 5 | 6)
    {
        return false;
    }
