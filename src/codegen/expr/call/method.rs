...
impl<'ctx> CodeGenerator<'ctx> {
    ...
    fn compile_enum_constructor_call(
        ...
        // emit_direct_call loads list/record allocas when ctor takes by-value struct.
                                ...
                                if let Type::Tuple(elems) = opt_inner.unlocated() {
                                    ...
                                    let list_ptr = self
                                        .build_call(
                                            ...
                                            "list_from_json_set_option_product",
                                        )?
                                        .try_as_basic_value_opt()
                                        .ok_or("list from_json set option product void")?
                                        .into_pointer_value();
                                    let list_ty = self.list_struct_type();
                                    let loaded = self
                                        .builder
                                ...
                                if let Type::Tuple(elems) = map_val.unlocated() {
                                    ...
                                    let list_ptr = self
                                        .build_call(
                                            ...
                                            "list_from_json_res_map_product",
                                        )?
                                        .try_as_basic_value_opt()
                                        .ok_or("list from_json result map product void")?
                                        .into_pointer_value();
                                    let list_ty = self.list_struct_type();
                                    let loaded = self
                                        .builder
                                            ...
                                            if on == "Option" && oargs.len() == 1 {
                                                ...
                                                if let Type::Tuple(elems) = opt_inner.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_list_set_option_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                            ...
                                            if mapn == "Map" && mapargs.len() == 2 {
                                                ...
                                                if let Type::Tuple(elems) = map_val.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_list_set_map_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                            ...
                                            if ln2 == "List" && largs2.len() == 1 {
                                                ...
                                                if let Type::Tuple(elems) = list_elem.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_list_map_list_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                    ...
                                    if mn == "Map" && margs.len() == 2 {
                                        ...
                                        if let Type::Tuple(elems) = map_val.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_list_map_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                    ...
                                    if sn == "Result" && sargs.len() == 2 {
                                        ...
                                        if let Type::Tuple(elems) = res_ok.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_map_result_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                    ...
                                    if sn == "List" && sargs.len() == 1 {
                                        ...
                                        if let Type::Tuple(elems) = list_elem.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_map_list_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                    ...
                                    if sn == "Option" && sargs.len() == 1 {
                                        ...
                                        if let Type::Tuple(elems) = opt_inner.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_map_option_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                            ...
                                            if mapn == "Map" && mapargs.len() == 2 {
                                                ...
                                                if let Type::Tuple(elems) = map_val.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_set_list_map_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                    ...
                                    if mn == "List" && margs.len() == 1 {
                                        ...
                                        if let Type::Tuple(elems) = list_elem.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_set_list_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                    ...
                                    if mn == "Option" && margs.len() == 1 {
                                        ...
                                        if let Type::Tuple(elems) = opt_inner.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_set_option_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                            ...
                                            if on == "Option" && oargs.len() == 1 {
                                                ...
                                                if let Type::Tuple(elems) = opt_inner.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_set_result_option_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                            ...
                                            if on == "Option" && oargs.len() == 1 {
                                                ...
                                                if let Type::Tuple(elems) = opt_inner.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_list_result_option_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                    ...
                                    if mn == "Result" && !margs.is_empty() {
                                        ...
                                        if let Type::Tuple(elems) = res_ok.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_list_result_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                                ...
                                                if let Type::Tuple(elems) = list_elem.unlocated() {
                                                    if ln == "Option" {
                                                        ...
                                                        let result = self.build_call(
                                                            ...
                                                            "map_from_json_option_map_list_product",
                                                        )?;
                                                        return Ok(self
                                                            .expect_basic_value(
                                                                &result,
                                        ...
                                        if let Type::Tuple(elems) = map_val.unlocated() {
                                            ...
                                            let (fn_name, label) = if ln == "Option" {
                                                ...
                                                (
                                                    ...
                                                    "map_from_json_result_map_product",
                                                )
                                            };
                                            let func = self.get_runtime_fn(fn_name)?;
                                            let result = self.build_call(
                                                ...
                                                if mn2 == "Map" && margs2.len() == 2 {
                                                    ...
                                                    if let Type::Tuple(elems) = map_val.unlocated()
                                                    {
                                                        ...
                                                        let result = self.build_call(
                                                            ...
                                                            "map_from_json_option_set_map_product",
                                                        )?;
                                                        return Ok(self
                                                            .expect_basic_value(
                                                                &result,
                                                ...
                                                if ln2 == "List" && largs2.len() == 1 {
                                                        ...
                                                        list_elem.unlocated()
                                                    {
                                                        ...
                                                        let result = self.build_call(
                                                            ...
                                                            "map_from_json_option_set_list_product",
                                                        )?;
                                                        return Ok(self
                                                            .expect_basic_value(
                                                                &result,
                                                ...
                                                if mn2 == "Map" && margs2.len() == 2 {
                                                    ...
                                                    if let Type::Tuple(elems) = map_val.unlocated()
                                                    {
                                                        ...
                                                        let result = self.build_call(
                                                            ...
                                                            "map_from_json_result_set_map_product",
                                                        )?;
                                                        return Ok(self
                                                            .expect_basic_value(
                                                                &result,
                                    ...
                                    if ln == "Option" && mn == "List" && margs.len() == 1 {
                                            ...
                                            if mapn == "Map" && mapargs.len() == 2 {
                                                ...
                                                if let Type::Tuple(elems) = map_val.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_option_list_map_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                        ...
                                        if let Type::Tuple(elems) = list_elem.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_option_list_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                            ...
                                            if mapn == "Map" && mapargs.len() == 2 {
                                                ...
                                                if let Type::Tuple(elems) = map_val.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_result_list_map_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                            ...
                                            if on == "Option" && oargs.len() == 1 {
                                                ...
                                                if let Type::Tuple(elems) = opt_inner.unlocated() {
                                                    ...
                                                    let result = self.build_call(
                                                        ...
                                                        "map_from_json_result_list_option_product",
                                                    )?;
                                                    return Ok(self
                                                        .expect_basic_value(
                                                            &result,
                                    ...
                                    if ln == "Result" && mn == "List" && margs.len() == 1 {
                                        ...
                                        if let Type::Tuple(elems) = list_elem.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_result_list_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                    ...
                                    if ln == "Option" && mn == "Result" && !margs.is_empty() {
                                        ...
                                        if let Type::Tuple(elems) = res_ok.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_option_result_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                                    ...
                                    if ln == "Result" && mn == "Option" && margs.len() == 1 {
                                        ...
                                        if let Type::Tuple(elems) = opt_inner.unlocated() {
                                            ...
                                            let result = self.build_call(
                                                ...
                                                "map_from_json_result_option_product",
                                            )?;
                                            return Ok(self
                                                .expect_basic_value(
                                                    &result,
                            ...
                            if ln == "List" && largs.len() == 1 {
                                ...
                                if let Type::Tuple(elems) = list_elem.unlocated() {
                                    ...
                                    let result = self.build_call(
                                        ...
                                        "set_from_json_result_list_product",
                                    )?;
                                    return Ok(self
                                        .expect_basic_value(
                                            &result,
                            ...
                            if mn == "Map" && margs.len() == 2 {
                                ...
                                if let Type::Tuple(elems) = map_val.unlocated() {
                                    ...
                                    let result = self.build_call(
                                        ...
                                        "set_from_json_result_map_product",
                                    )?;
                                    return Ok(self
                                        .expect_basic_value(
                                            &result,
                            ...
                            if ln == "List" && largs.len() == 1 {
                                ...
                                if let Type::Tuple(elems) = list_elem.unlocated() {
                                    ...
                                    let result = self.build_call(
                                        ...
                                        "set_from_json_map_list_product",
                                    )?;
                                    return Ok(self
                                        .expect_basic_value(
                                            &result,
