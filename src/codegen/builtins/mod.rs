...
fn register_map_record_fns<'ctx>(
    ...
    module.add_function(
        "mimi_map_from_json_product_i64",
        i64.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_set_to_json_option_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::IntType(i64),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_set_result_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_set_option_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_set_map_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_map_from_json_option_map_list_product_i64",
        i64.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_from_json_set_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_result_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_set_to_json_result_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::IntType(i64),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_set_to_json_result_option_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::IntType(i64),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_set_to_json_option_result_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::IntType(i64),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_map_from_json_result_map_product_i64",
        i64.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_result_map_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_result_set_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_option_product_to_json",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_from_json_option_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
    ...
    module.add_function(
        "mimi_list_from_json_map_product_i64",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
...
fn register_set_fns<'ctx>(
    ...
    module.add_function(
        "mimi_list_set_product_to_string",
        i8_ptr.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::IntType(i64),
...
fn register_binary_i_o_streaming_line_reading<'ctx>(
    ...
    module.add_function(
        ...
        i64.fn_type(
            &[
                BasicMetadataTypeEnum::PointerType(i8_ptr),
                BasicMetadataTypeEnum::PointerType(cb_ptr),
            ],
            false,
        ),
        Some(inkwell::module::Linkage::External),
...
pub fn is_builtin(name: &str) -> bool {
    crate::core::builtins::is_builtin_callable(name)
}
...
impl<'ctx> CodeGenerator<'ctx> {
    pub(super) fn compile_builtin_call(
        ...
        match name {
            ...
            "read_file_guarded" => self.compile_read_file_guarded(args),
            ...
            "make_token" => self.compile_make_token(args),
            "token_id" => self.compile_token_id(args),
            ...
            "get_env_guarded" => self.compile_get_env_guarded(args),
            ...
            "http_get_guarded" => self.compile_http_get_guarded(args),
            ...
            // Phase D (0.39.73): token 通道透传 channel 编译（运行时 i64 柄）。
            "token_channel_new" => self.compile_channel_new(args),
            "token_channel_send" => self.compile_channel_send(args),
            "token_channel_recv" => self.compile_channel_recv(args),
