...
impl PyBindGenerator {
    ...
    pub fn generate_pyi(&self, extern_funcs: &[ExternFunc]) -> Result<String, std::fmt::Error> {
        ...
        writeln!(out, "from typing import Any, Callable, List, Optional, Dict, Tuple")?;
        writeln!(out)?;
