...
| **0.1.7** | **Planned**. Deep usability + high-pressure reliability + Wave-3 structural campaign: core deep usability under high load, compiler backend unification, real structured-concurrency runtime, and immediate deterministic heap release. See `devdocs/v0.37/README.md`. |
