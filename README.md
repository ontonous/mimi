...
**Current**: 0.1.7-dev (Wave-3 infrastructure closeout complete 2026-08-19; `0.1.7` tag not cut). 0.1.6 shipped (2026-08-16). 0.1.7 is Wave-3 基建诚实收口 and does not claim kernel-vision purity. Next is 0.1.8 identity / L1 honesty — see `devdocs/kernel-roadmap-0.1.7-0.1.9.md`.
...
| **0.1.7-dev** | **Closeout complete (2026-08-19), tag not cut**. Wave-3 基建诚实收口 (zero-fallback dispatch gate, drop-glue, native threads, edge-feature removal). Does not claim VM≡native or implemented Flow generations. Next: 0.1.8 identity, 0.1.9 linear kinds. See `devdocs/v0.37/quad-final-0.37.135.md` and `devdocs/kernel-roadmap-0.1.7-0.1.9.md`. |
