...
**Current**: 0.1.7-dev. 0.1.6 shipped (2026-08-16): core deep closure with four pillars — failure attribution, state semantics, abstraction, linear system, and syntax redesign — all reached **定案 + 挣绿**; see `devdocs/v0.36/README.md`, `devdocs/v0.36/quad-final-0.36.114.md`, and `devdocs/v0.36/known-boundaries-0.1.6.md`. 0.1.7 (0.37.x) pivots to **deep usability + high-pressure reliability + Wave-3 structural campaign** — see `devdocs/v0.37/README.md`.
...
| [`devdocs/v0.37/README.md`](devdocs/v0.37/README.md) | 0.1.7 roadmap: deep usability + high-pressure reliability + Wave-3 structural campaign (authoritative for 0.1.7) |
...
| **0.1.7-dev** | **Current**. Deep usability + high-pressure reliability + Wave-3 structural campaign: core deep usability under high load, compiler backend unification, real structured-concurrency runtime, and immediate deterministic heap release. See `devdocs/v0.37/README.md`, `devdocs/v0.37/high-stress-testing-spec.md`, and `devdocs/v0.37/usability-dx-manifesto.md`. |
