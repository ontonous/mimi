...
**Current**: 0.1.7 (shipped 2026-08-19). Wave-3 基建诚实收口. Does not claim kernel-vision purity, VM≡native, or implemented Flow generations. Next is 0.1.8 identity / L1 honesty.
...
| **0.1.7** | **Shipped (2026-08-19)**. Wave-3 基建诚实收口 (zero-fallback dispatch gate, drop-glue, native threads, edge-feature removal, Wire/ABI CLI). Does not claim VM≡native or implemented Flow generations. Next: 0.1.8 identity, 0.1.9 linear kinds. |
